...
static LUA_FUNCTION (ban); // (int target_cn, int milliseconds = default ban time, int ban_type)
static LUA_FUNCTION (sendspawn); // (int target_cn)
static LUA_FUNCTION (flashonradar); // (int target_cn)
static LUA_FUNCTION (authclient); // (int target_cn)
// if
...
static LUA_FUNCTION (isauthed); // (int player_cn)
// get
...
static LUA_FUNCTION (getlastsay); // (int player_cn)
static LUA_FUNCTION (getlastsaytext); // (int player_cn)
// set
...
static LUA_FUNCTION (addmaprotentry); // (table maprotentry)
...
static LUA_FUNCTION (spawnitem); // (int item_id, table target_cns)
